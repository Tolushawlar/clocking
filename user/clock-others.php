...
<body class="bg-background font-display text-text-main antialiased">
    <div class="flex h-screen w-full overflow-hidden">
        ...
        <main class="flex-1 flex flex-col h-full overflow-y-auto bg-background relative">
            ...
            <div class="flex-grow flex flex-col items-center justify-center px-4 py-8 relative w-full h-full">
                ...
                <?php if ($message): ?>
                    <div class="fixed top-8 left-1/2 transform -translate-x-1/2 z-50 bg-green-50 border border-green-200 text-green-800 px-6 py-4 rounded-lg shadow-lg">
                        <div class="flex items-center gap-2">
                ...
                <?php if ($error): ?>
                    <div class="fixed top-8 left-1/2 transform -translate-x-1/2 z-50 bg-red-50 border border-red-200 text-red-800 px-6 py-4 rounded-lg shadow-lg">
                        <div class="flex items-center gap-2">
