        ...
        <div class="flex flex-col h-full">
            <div class="p-6">
                ...
                <nav class="flex flex-col gap-2">
                    <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-primary/10 text-primary transition-colors" href="scanner.php">
                        <span class="material-symbols-outlined filled">barcode_reader</span>
