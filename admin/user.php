...
<body class="bg-background-light dark:bg-background-dark text-text-main font-display antialiased min-h-screen flex flex-col">
    <!-- Top Navigation -->
    <header class="sticky top-0 z-50 w-full bg-surface-light dark:bg-surface-dark border-b border-border-color shadow-sm">
        <div class="px-6 md:px-10 py-3 flex items-center justify-between">
            <div class="flex items-center gap-4 text-text-main dark:text-white">
                ...
                <h2 class="text-lg font-bold leading-tight tracking-[-0.015em]">TimeTrack Pro</h2>
            </div>
            <div class="flex items-center gap-4">
                <a href="dashboard.php" class="flex items-center gap-2 px-4 py-2 text-text-secondary hover:text-primary hover:bg-background-light rounded-lg transition-colors">
                    <span class="material-symbols-outlined text-[20px]">arrow_back</span>
                    <span class="hidden sm:inline">Back to Dashboard</span>
                </a>
                <div class="flex items-center gap-3 pl-4 border-l border-border-color">
                    <div class="text-right hidden sm:block">
                        <p class="text-sm font-semibold text-text-main dark:text-white"><?php echo htmlspecialchars($user['firstname'] . ' ' . $user['lastname']); ?></p>
                        <p class="text-xs text-text-secondary"><?php echo ucfirst($user['category']); ?></p>
                    </div>
                    <div class="bg-gradient-to-br from-blue-500 to-purple-600 rounded-full size-10 flex items-center justify-center text-white font-semibold text-sm">
    ...
    <!-- Main Layout -->
    <main class="flex-1 w-full max-w-[1280px] mx-auto px-4 sm:px-6 md:px-10 py-8">
        <!-- Breadcrumbs -->
        <nav class="flex items-center gap-2 mb-6 text-sm">
            ...
            <a class="text-text-secondary hover:text-primary transition-colors font-medium" href="dashboard.php">Staff Directory</a>
            <span class="text-text-secondary/50 font-medium">/</span>
